...
const DashboardLayout = () => {
	...
	return (
		<section className="flex md:bg-gray-100 min-h-screen max-h-screen overflow-hidden">
			{/* SideBar section  */}
			<aside className="hidden sm:flex sm:flex-col">
				...
				<div className="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
					<nav className="flex flex-col mx-4 my-6 space-y-4">
						<Link className="inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
